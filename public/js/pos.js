...
/**
 * @deprecated Use pos_print_util from POS Class instead
 */
function pos_print(transaction_result) {
    console.warn('pos_print() is deprecated. Using pos_print_util() from POS Class instead.');
    const pos_instance = new POS();
    return pos_instance.pos_print_util(transaction_result);
}
