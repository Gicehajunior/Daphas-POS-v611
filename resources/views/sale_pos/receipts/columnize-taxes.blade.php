...
<html lang="en">
    <head>
		...
		<style>
			...
			.additional_notes, .barcode-div, .footer_text {
				text-align: center;
				align-items: center;
			}
		</style>
					...
					<td>
									...
									<tbody>
										@foreach($receipt_details->lines as $line)
											<tr>
												...
												<td class="text-right">
													@if($receipt_details->show_quantity == 1)
														{{$line['quantity']}}
													@endif
						...
						<div class="border-bottom col-md-12">
							...
							@if(empty($receipt_details->hide_price) && !empty($receipt_details->tax_summary_label) )
								@php
									$receipt_details->tax_summary_label = "Summary";
								@endphp
								<!-- tax -->
									...
									<table class="table table-slim table-bordered">
										...
										<tr>
											...
											<td class="text-center"><b> 
												</b>Ksh <span class="text-center display_currency" data-currency_symbol="false">{{($totals['taxable_value'])}}</span>
											</td>
										</tr>
										...
										<tr>
											...
											<td class="text-center">{{ $receipt_details->subtotal }}</td>
										</tr>
									</table>
								@endif
							@endif
						...
						@if(!empty($receipt_details->additional_notes))
							<div class="row ">
								<div class="col-xs-12">
									<br>
									<p class="additional_notes">{!! nl2br($receipt_details->additional_notes) !!}</p>
								</div>
							</div>
						@endif
						...
						<div class="row barcode-div">
							@if(!empty($receipt_details->footer_text))
								<div class="footer-text-div @if($receipt_details->show_barcode || $receipt_details->show_qr_code) col-xs-8 @else col-xs-12 @endif">
									<p class="footer_text">{!! $receipt_details->footer_text !!}</p>
								</div>
							@endif
