<div class="pos-tab-content">
    ...
    <hr>
    @include("business.partials.other_partials.settings_transaction_statuses") 
    <hr>
    ...
    <div class="row">
        ...
        @include("business.partials.other_partials.settings_pos_extras") 
    </div> 
     
    <hr>
    @include("business.partials.other_partials.settings_esd_device") 
    <hr>
    @include("business.partials.other_partials.settings_pos_authentication") 
    <hr>
